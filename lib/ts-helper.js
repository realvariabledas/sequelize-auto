...
function getDefinitionFileStart() {
  return 'import { Model, HasManyGetAssociationsMixin, HasManyAddAssociationMixin, HasManyHasAssociationMixin, Association, HasManyCountAssociationsMixin, HasManyCreateAssociationMixin } from \'sequelize\';\n' +
         'import { DI } from \'../../di/DIContainer\';\n';

}

function getTableDefinition(tsTableDefAttr, tableName, isLastOne) {
  var tableDef = tsTableDefAttr + '\n';
  if (!isLastOne) {
    tableDef += '}\n';
  }
  return tableDef;
