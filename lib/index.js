            ...
            for (const pkey of Object.keys(self.associationKeys)) {
              ...
              for (const ckey of Object.keys(self.associationKeys[pkey])) {
                for (const colKey of Object.keys(self.associationKeys[pkey][ckey])) {
                  ...
                  tsTableDef += primaryTableName + '.hasMany(' + childTableName + ', {\n'
                  tsTableDef += spaces + 'sourceKey: \''+ self.tablePrimaryKeys[pkey] +'\'';
                  tsTableDef += spaces + 'foreignKey: \''+colKey+'\'';
                  tsTableDef += spaces + 'as: \''+self.associationKeys[pkey][ckey][colKey]+'\'';
                  tsTableDef += '});\n';
                }
              }
            }
