...
AutoSequelize.prototype.build = function(callback) {
  ...
  function mapForeignKeys(table, fn) {
    ...
    function assignColumnDetails(ref) {
      ...
      // self.associationKeys[table] = self.associationKeys[table] || {};
      // self.associationKeys[table][target_table] = self.associationKeys[table][target_table] || {};
      // self.associationKeys[table][target_table][target_column] = getPascalName(target_column + table);
