...
AutoSequelize.prototype.build = function(callback) {
  ...
  function mapForeignKeys(table, fn) {
    ...
    function assignColumnDetails(ref) {
      ...
      self.associationKeys[source_table] = self.associationKeys[source_table] || {};
      self.associationKeys[source_table][target_table] = self.associationKeys[source_table][target_table] || {};
      self.associationKeys[source_table][target_table][target_column] = getPascalName(target_column + source_table);
