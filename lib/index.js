  ...
  function mapForeignKeys(table, fn) {
    ...
    function assignColumnDetails(ref) {
      ...
      if (ref.foreignSources !== undefined) {
        ...
        self.associationKeys[ref.foreignSources.target_table][table][ref.foreignSources.source_column] = getPascalName(ref.foreignSources.source_column + table);
      }
          ...
          if (Object.keys(self.associationKeys[table]).length > 0) {
            ...
            for (const subTable of subTables) {
              ...
              for (const col of cols) {
                tsTableDef += self.associationKeys[table][subTable][col] + ': ' + getPascalName(subTable) + ';\n';
              }
            }
          }
        }
